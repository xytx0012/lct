...
import com.xytx.utils.HttpUtil;
import com.xytx.utils.Pkipair;
...
public class KQService {
    ...
    /*获取用户信息*/
    public UUser queryUser(Integer uid){
